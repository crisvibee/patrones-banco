...
public class TransferCommand implements Command {
    ...
    public void undo() {
        if (executed && wasSuccessful) {
            ...
            // Simular deshacer la transferencia
            // Devolver el dinero a la cuenta origen
            System.out.println("Transferencia de $" + amount + " deshecha");
            System.out.println("Balance cuenta origen restaurado a $" + sourcePreviousBalance);
            System.out.println("Balance cuenta destino restaurado a $" + destinationPreviousBalance);
